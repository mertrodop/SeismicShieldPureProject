...
const SignUp = () => {
  ...
  return (
    <View style={styles.contaier}>
        ...
        <View style={styles.inputcontainer}>
            <FontAwsome name={"user"} size={24} color={"#9A9A9A"} style={styles.inputicon} ></FontAwsome>
            <TextInput style={styles.textinput} placeholder='Student Number'></TextInput>
        </View>
        <View style={styles.inputcontainer}>
            <FontAwsome name={"phone"} size={24} color={"#9A9A9A"} style={styles.inputicon} ></FontAwsome>
        ...
        <View style={styles.inputcontainer}>
            <Fontisto name={"locked"} size={24} color={"#9A9A9A"} style={styles.inputicon} secureTextEntry={true} ></Fontisto>
            <TextInput style={styles.textinput} placeholder='Password again'></TextInput>
        </View>
...
const styles = StyleSheet.create({
    ...
    imageContainer: {
        ...
        zIndex: 0, // Lower zIndex to be behind the button
    },
    bottomImage: {
